...
<template>
  <div>
    <div v-if="currentSlideRoute.no === 1" class="absolute bottom-1/2 right-24 translate-y-1/2 w-64">
      <img src="/backgrounds/cover.jpg" class="rounded-lg">
    </div>
    <div
    ...
    <Transition name="fade">
      <div v-if="!!formatter.poweredBy" absolute bottom-5 right-5 w-35>
